...
from modules.shapenet import ShapeNetDataset 
...
def test_shapenet_dataset():
	dataset_root = '/home/gatheluck/Scratch/benchmarks/data/ShapeNetSingle'
	categories = ['02691156']
	dataset = ShapeNetDataset(dataset_root, categories, transform=None, split=1.0)
